...
void display(struct employee *pemps, int *pindxs){
...
void search(int netSal, struct employee *pemps, int *pindxs){
    for(int i=0;i<SIZE;i++){
...
void displayall(struct employee *pemps, int *pindxs){
...
void viewlist(struct employee *pemps, int *pindxs){
        ...
        if(key == -32)
        {
            ...
            if (key == 13)
            {
                ...
                case 0:
                   ...
                   break;
                case 1:
                   display(&pemps, &pindxs);
                   break;
                case 2:
                    displayall(&pemps, &pindxs);
                    break;
                case 3:
                    printf("Enter net salary: \n");
                    int netsal;
                    scanf("%d",&netsal);
                    search(netsal, &pemps, &pindxs);
                    break;
                case 4:
                     printf("exit");
                     x= 0 ;
...
int main()
{
    struct employee emps[SIZE], *pemps = &emps[0];
    int indexes[SIZE], *pindxs= &indexes[0];

    viewlist(pemps, pindxs);
    return 0;
}
